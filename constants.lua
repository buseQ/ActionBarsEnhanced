...
Addon.Templates = {
    ...
    NormalTextures = {
        ...
        },
        {
            ...
            atlas = "wowlabs-in-world-item-common",
            point = "CENTER",
            padding = {-0.5, 0.5},
            size = {55,55},
        },
        {
            name = "Plunderstorm",
            atlas = "plunderstorm-actionbar-slot-border",
            point = "CENTER",
            padding = {-0.5, 0.5},
            size = {58,58},
        },
        --[[ {
            name = "Renown",
            atlas = "covenantsanctum-renown-icon-border-standard",
            point = "TOP",
            padding = {0, 11},
            size = {58,65},
        }, ]]
        ...
        {
            name = "Talents Gray",
            atlas = "talents-node-choiceflyout-square-gray",
            point = "CENTER",
            size = {45,45},
        },
        {
            name = "Cypher",
            atlas = "cyphersetupgrade-leftitem-border-empty",
            point = "CENTER",
            padding = {-0.5, 1},
            size = {54,62},
        },
        ...
        {
            name = "Relicforge",
            atlas = "Relicforge-Slot-frame",
            point = "CENTER",
            size = {62,62},
        },
        {
            name = "Runecarving",
            atlas = "runecarving-icon-reagent-selected",
            point = "CENTER",
            padding = {-0.5, 0.5},
            size = {55,55},
        },
        {
            name = "Soulbinds",
            atlas = "Soulbinds_Collection_SpecBorder_Primary",
            point = "CENTER",
            size = {68,68},
        },
    },
    ...
    IconMaskTextures = {
        ...
        },
        {
            ...
            atlas = "UI-HUD-CoolDownManager-Mask",
            point = "CENTER",
            padding = {0, 0},
            size = {45,45},
        },
        ...
        {
            name = "Hexagon Mask",
            atlas = "CovenantSanctum-Renown-Hexagon-Mask",
            point = "CENTER",
            padding = {0, 0},
            size = {60,60},
        },
